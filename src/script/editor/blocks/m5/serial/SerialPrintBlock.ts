...
export class SerialPrintBlock extends CodeBlock {
    public static readonly IDENTIFIER: string = "m5-serial-print";
    public static readonly INPUT: string = "INPUT"

    public identifier(): string {
        return SerialPrintBlock.IDENTIFIER;
    }
    ...
    protected definition(): BlockDefinition {
        return {
            init: function () {
                this.appendValueInput(SerialPrintBlock.INPUT)
                    .appendField('print')
    ...
    protected generateCode(block: Blockly.Block, generator: Blockly.CodeGenerator): string | [string, number] {
        const input = generator.valueToCode(block, SerialPrintBlock.INPUT, Order.NONE);

        return 'Serial.print(' +  input + ');';
    }
